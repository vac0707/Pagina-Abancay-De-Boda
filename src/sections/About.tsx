...
export const About: React.FC = () => {
  return (
    <section id="nosotros" className="relative py-28 md:py-40 bg-ivory overflow-hidden">
      {/* Brand accent watermark */}
      <div className="brand-circle-accent w-[650px] h-[650px] -right-52 top-1/2 -translate-y-1/2 opacity-10" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden aspect-[4/5] bg-espresso rounded-xs shadow-2xl border border-border-warm">
                <img
                  ...
                  loading="lazy"
                  className="w-full h-full object-cover filter grayscale contrast-110 group-hover:grayscale-0 transition-all duration-1000 ease-out"
                />
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {/* Existing Studio Highlights (No invented data) */}
